					...
					<tr data-oferta="{{ $oferta }}" data-empresa="{{ $oferta->empresa }}">
						...
						<td>
							<a href="{{url('/admin/ofertas/editarOferta', $oferta->id )}}">
								<img src="{{ url('assets/images/editar.png') }}" alt=""></a><!--editar-->
							<a href="#eliminarOferta" class="btn-showDelete">
								<img src="{{ url('assets/images/eliminar.png') }}" alt=""></a><!--Eliminar-->
						</td>
					</tr>
				@endforeach
			</tbody>
	...
	<div id="verOferta" class="modaloverlay"> <!-- div-modaloverlay -->
		<div class="modal"> <!-- div-modal -->
			...
			<div class="parte-2"><!--parte-2-->
				...
				<br><div class="item-1"><!--item-1-->
					<div class="icono">Descripción:</div>
					<div class="descripcion" id="getDescripcion" style="text-align: justify; overflow:auto;"></div><!--descripcion-->
				</div><!--item-1-->

				<br><div class="item-1"><!--item-1-->
					<div class="icono">Ubicación:</div>
					<div class="descripcion" id="getUbicacion"></div><!--descripcion-->
				</div><!--item-1-->

				<br><div class="item-1"><!--item-1-->
					<div class="icono">Salario:</div>
					<div class="descripcion" id="getSalario"></div><!--descripcion-->
				</div><!--item-1-->

				<br><div class="item-1"><!--item-1-->
					<div class="icono">Experiencia:</div>
					<div class="descripcion" id="getExperiencia"></div><!--descripcion-->
				</div><!--item-1-->

				<br><div class="item-1"><!--item-1-->
					<div class="icono">Carrera:</div>
					<div class="descripcion" id="getCarrera"></div><!--descripcion-->
				</div><!--item-1-->

				<br><div class="item-1"><!--item-1-->
					<div class="icono">Estatus:</div>
					<div class="descripcion" id="getStatus"></div><!--descripcion-->
				</div><!--item-1-->

				<!--<a href="{{ URL::previous() }}">Volver</a>-->
				<br><a href="#close"><button type="button" class="flat-secundario">Regresar</button></a>
			</div>
		</div> <!-- div-modal -->
		...
		<div class="modal"> <!-- div-modal -->
			...
			<form action="{{route('admin.eliminarOferta.submit')}}" method="post">
				<div class="parte-2"><!--parte-2-->
					...
					<br><div class="item-1"><!--item-1-->
						<div class="icono">Descripción:</div>
						<div class="descripcion" id="getDescripcionD" style="text-align: justify; overflow:auto;"></div><!--descripcion-->
					</div><!--item-1-->
					...
					<!--<a href="{{ URL::previous() }}">Volver</a>-->
					<br><a href="#close">
						<button type="button" class="flat-secundario">Cancelar</button></a>
